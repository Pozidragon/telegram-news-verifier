"""Grid search over TF-IDF verifier thresholds using saved similarity scores."""
...
def main() -> None:
    ...
    predicted = load_jsonl(TFIDF_RESULTS_PATH)
    ...
    thresholds = [round(v * 0.05, 2) for v in range(1, 20)]  # 0.05 .. 0.95
    best = {"accuracy": -1.0}
    ...
    out_path = Settings.EXPERIMENTS_DIR / "tfidf_grid_search.json"
